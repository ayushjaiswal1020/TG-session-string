...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#STRING_SESSION of your account \n\n```{session_string}``` \n\nA Bot By @infozoxdesign")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Channel', url='https://t.me/infozoxdesign'),
                InlineKeyboardButton('Developer', url='https://t.me/infozoxdesignsupport')
            ],
            [
                InlineKeyboardButton('Msg For Any Help', url='https://t.me/infozoxdesign_roBot'),
            ]
